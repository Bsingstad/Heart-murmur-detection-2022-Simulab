...
#### The 1-D CNN Architecture of the two classifiers
...
### Python scripts
This repository contains code written in python. Some scripts can be edited while others provided by the organizers of George B. Moody PhysioNet Challenge 2022 should **NOT** be edited
